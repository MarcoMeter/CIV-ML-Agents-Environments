...
namespace MLAgents
{
    ...
    public class BodyPart
    {
        ...
        public void SetJointTargetRotation(float x, float y, float z)
        {
            ...
            var xRot = Mathf.Lerp(-180f, 180f, x);
            var yRot = Mathf.Lerp(-180f, 180f, y);
            var zRot = Mathf.Lerp(-180f, 180f, z);
            ...
            if (joint.angularXMotion == ConfigurableJointMotion.Limited)
            {
                ...
                currentXNormalizedRot = Mathf.InverseLerp(joint.lowAngularXLimit.limit, joint.highAngularXLimit.limit, x);
            }
            else
            {
                currentXNormalizedRot = Mathf.InverseLerp(0f, 360f, x);
            }
            ...
            if (joint.angularYMotion == ConfigurableJointMotion.Limited)
            {
                ...
                currentYNormalizedRot = Mathf.InverseLerp(-joint.angularYLimit.limit, joint.angularYLimit.limit, y);
            }
            else
            {
                currentYNormalizedRot = Mathf.InverseLerp(0f, 360f, y);
            }
            ...
            if (joint.angularZMotion == ConfigurableJointMotion.Limited)
            {
                ...
                currentZNormalizedRot = Mathf.InverseLerp(-joint.angularZLimit.limit, joint.angularZLimit.limit, z);
            }
            else
            {
                currentZNormalizedRot = Mathf.InverseLerp(0f, 360f, z);
            }
